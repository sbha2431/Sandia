...
ncols = 20
nagents = 6
initial = [44,222,182,282,190,237]
targets = [[],[],[],[],[],[]]
...
allowed_states[3] = [209,210,211,212,226,227,228,229,230,231,244,245,246,247,248,249,250,261,262,263,264,265,266,267,268,
                     280,281,282,283,284,285,286,287,300,301,302,303,305,306,307]
...
partitionGrid0[(0,1)] = [5,6,7,8,9,10,26,27,28,29,30,45,46,47,48]
partitionGrid0[(1,1)] = [65,66,67,68,85,86,87,105,106,107,108,109,110,125,126,127,128,129,130]
partitionGrid1[(1,0)] = [10,11,12,13,30,31,32,33,52,53]
partitionGrid1[(2,0)] = [72,73,90,91,92,93,110,111,112,113,130,131,132,133,152,153]
partitionGrid1[(3,0)] = [14,15,16,17,18,19,34,35,36,38,39,54,55,56,57,58,59]
partitionGrid1[(4,0)] = [74,75,76,77,78,79,94,95,96,97,98,99,114,115,116,117,118,119,
...
partitionGrid4[(1,0)] = [271,272,273,291,292,293,311,312,331,332,
                         351,352,353,371,372,373,391,392,393]
...
partitionGrid5[(3,0)] = [316,317,318,319,]
