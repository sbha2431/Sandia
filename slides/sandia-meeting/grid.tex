...
\uncover<1>{
\node at (1.25,0.75) {\includegraphics[scale=0.025]{./pics/agent.pdf}};
}
\uncover<2>{
\node at (0.75,0.75) {\includegraphics[scale=0.025]{./pics/agent.pdf}};
}
\uncover<3-4>{
\node at (0.25,0.75) {\includegraphics[scale=0.025]{./pics/agent.pdf}};
}
\uncover<1>{
\node at (-1.25,0.75) {\includegraphics[scale=0.025]{./pics/target.pdf}};
}
\uncover<2>{
\filldraw[fill=white,draw=orange,very thick] (-1.5,0) rectangle (-1,0.5);
\node at (-1.25,0.25) {\includegraphics[scale=0.025]{./pics/target.pdf}};
}
