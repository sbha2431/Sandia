...
We model the sensors as having an omnidirectional vision with limited range. All the black states in the gridworld are states that are currently not in the range of any of the sensors. 
