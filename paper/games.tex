...
The transition relation $T$ encodes the one-step move of the target and the $n$ sensors, where the target moves first and the sensors move jointly second. For a state $(l,l_t)$ we denote $\succs_t(l,l^t)$ as the set of successor locations of the target:
