...
\node  [below left of=s0,yshift=-.5cm,xshift=-2.2cm] (s1) {$v_1:(3,\{Q_2\})$};
\node  [below right of=s0,yshift=-.5cm,xshift=2.2cm] (s2) {$v_2:(9,\{Q_2\})$};
\node  [below of=s1,yshift=-.5cm] (s4) {$v_4:(4,A)$};
\node  [below of=s2,yshift=-.5cm] (s7) {$v_7:(8,A)$};
