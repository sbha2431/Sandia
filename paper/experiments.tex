We now return to the case study outlined in section \ref{sec:casestudy}. We look at two scenarios. In figure \ref{fig:experiment}, we have 6 available mobile sensors. In figure \ref{label}
